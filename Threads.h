...
namespace samediff {
    ...
    public:
        ...
        */
        ...
        static int   parallel_aligned_increment2(Op function, int64_t start, int64_t stop, int64_t increment, bool adjust = true, size_t type_size = sizeof(float), uint32_t req_numThreads = sd::Environment::getInstance()->maxMasterThreads()) {
            if (start > stop)
